...
let colors_name = "cyim"

set background=dark

if version >= 700
    hi CursorLine    guifg=NONE     guibg=#494949  gui=NONE
    hi CursorColumn  guifg=NONE     guibg=#494949  gui=NONE
...
"  General      colors
hi Cursor       guifg=NONE    guibg=#D10000 gui=NONE
...
hi Visual       guifg=#F6F3E8 guibg=#FF1FF1 gui=NONE
hi SpecialKey   guifg=#B69AB5 guibg=NONE    gui=NONE
